// Mock data service for Schurr High School app
const DataService = {
  // User data
  currentUser: {
    id: 'user1',
  ...
  posts: [
    {
      ...
      content: 'Next week is Spirit Week! Don\'t forget to dress up according to the themes.',
    ...
    },
    {
      ...
      content: 'Congratulations to our basketball team for winning against Roosevelt High!',
  ...
  // Clubs data
  clubs: [
    { id: 'club1', name: 'Book Club', members: 28, icon: 'book' },
    { id: 'club2', name: 'Science Enthusiasts', members: 35, icon: 'flask' },
    { id: 'club3', name: 'Debate Team', members: 20, icon: 'chatbubbles' },
    { id: 'club4', name: 'Art Club', members: 32, icon: 'brush' }
  ],
